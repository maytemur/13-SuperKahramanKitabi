...
class RecyclerAdapter(val kahramanlarListesi:ArrayList<String>,
    ...
    override fun onBindViewHolder(holder: SuperKahramanVH, position: Int) {
        holder.itemView.recyclerViewTextView.text = kahramanlarListesi.get(position)
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context,TanitimActivity::class.java)
            intent.putExtra("superKahramanismi",kahramanlarListesi.get(position))
    ...
    override fun getItemCount(): Int {
        return kahramanlarListesi.size
    }
